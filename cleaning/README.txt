...
2. Open 'execute_cleaning.py'
3. Change your 'path'(working directory = path\cleaning) and 'data_path'
4. Change values of colnames to fit your data column names
...
5. In function 'factorize()', change argument 'wireless_colname' (wireless, bluetooth, wired), 'type_colname' (on-ear,in-ear,over-ear) to fit your specific dataset

- Run 'execute_cleaning.py'
6. run 'execute_cleaning.py'; This will save a new csv to your path called 'products_cleaned+time.csv'
7. Go to your working directory (/cleaning), change the new csv name to 'products_cleaned.csv'

- Remove extra columns
8. open 'remove_extra_columns.py'
9. Change 'col_remove' to columns you wish to remove from your specific dataset (columns that don't contribute to feature analysis)
10. run 'remove_extra_columns.py'; This will save a csv to path called 'products_cleaned_colremoved+time.csv'
